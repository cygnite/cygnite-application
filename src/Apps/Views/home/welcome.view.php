    ...
    <ul class="thumbnails">
        ...
        <li class="span3">
            <div class="feature-block">
                ...
                <p>Cygnite provides a powerful router that response to route callbacks to specific HTTP request methods and URIs. RESTful
                    resource controllers allows you to build powerful REST api. </p>
            </div>
        </li>
        ...
        <li class="span3">
            <div class="feature-block">
                <div class="features-head">
                    <h3 class="title">
                        <a href="http://www.cygniteframework.com/2013/08/active-record.html">Cyrus <span class="title-em">ORM</span></a></h3>
                </div>
        ...
        <li class="span3">
            <div class="feature-block">
                <div class="features-head">
                    <h3 class="title">
                        <a href="http://www.cygniteframework.com/2014/03/console-overview.html"> Craft <span class="title-em">Console</span></a></h3>
                </div>
